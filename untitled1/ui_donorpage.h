...
""));
        ...
        donationStatus->setGeometry(QRect(360, 440, 321, 51));
...
""));
        ...
        updateDataPage->setGeometry(QRect(0, 50, 791, 471));
...
"\n"
""));
        bloodTypeFeild_2 = new QLineEdit(updateDataPage);
        bloodTypeFeild_2->setObjectName("bloodTypeFeild_2");
        bloodTypeFeild_2->setGeometry(QRect(170, 140, 111, 28));
        bloodTypeFeild_2->setReadOnly(true);
    ...
    void retranslateUi(QMainWindow *DonorPage)
    {
        ...
        bloodTypeFeild_2->setText(QCoreApplication::translate("DonorPage", "ID", nullptr));
